...
<html lang="ja">
  <head>
    ...
    <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/htdocs/assets/img/favicon.ico">
    <!--[if lt IE 9]>
    <script src="//cdn.jsdelivr.net/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js"></script>
    <![endif]-->
    <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/htdocs/assets/img/images/favicon.ico">
    <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/htdocs/assets/img/images/favicon.ico">
    <link rel="apple-touch-icon" href="<?php bloginfo('template_url'); ?>/htdocs/assets/img/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" href="<?php bloginfo('template_url'); ?>/htdocs/assets/img/images/android-chrome-256x256.png">
