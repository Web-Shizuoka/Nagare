...
<html lang="ja">
  <head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/assets/img/images/favicon.ico">
    <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/assets/img/images/favicon.ico">
    <link rel="apple-touch-icon" href="<?php bloginfo('template_url'); ?>/assets/img/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" href="<?php bloginfo('template_url'); ?>/assets/img/images/android-chrome-256x256.png">
